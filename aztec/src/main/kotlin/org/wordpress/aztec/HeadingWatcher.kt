...
class HeadingWatcher private constructor(private val headingHandler: HeadingHandler, aztecText: AztecText) : TextWatcher {
    ...
    override fun onTextChanged(s: CharSequence, start: Int, before: Int, count: Int) {
        ...
        headingHandler.handleTextChangeForHeadings(
                s as Spannable,
                start,
                count,
                textDeleter)
    ...
    companion object {
        fun install(text: AztecText) {
            text.addTextChangedListener(HeadingWatcher(HeadingHandler(), text))
        }
    }
}