...
class AztecParserTest : AndroidTestCase() {
    ...
    fun parseHtmlToSpanToHtmlAll_isEqual() {
        ...
        val span = SpannableString(mParser.fromHtml(input, null, null, null, context))
    ...
    fun parseHtmlToSpanToHtmlLinebreakFollowedByBlock_isEqual() {
        ...
        span = SpannableString(mParser.fromHtml(input, null, null, null, context))
    ...
    fun parseHtmlToSpanToHtmlMore_isEqual() {
        val input = HTML_MORE
        val span = SpannableString(mParser.fromHtml(input, null, null, null, RuntimeEnvironment.application.applicationContext))
        val output = mParser.toHtml(span)
        Assert.assertEquals(input, output)
    }
    ...
    fun parseSpanToHtmlToSpanAll_isEqual() {
        ...
        val output = mParser.fromHtml(html, null, null, null, context)
        Assert.assertEquals(input, output)
    }
    ...
    fun parseHtmlToSpanToHtmlLineBreakBetweenHeadings_isEqual() {
        ...
        val span = SpannableStringBuilder(mParser.fromHtml(input, null, null, null, context))
        val output = mParser.toHtml(span)
        Assert.assertEquals(input, output)
    }
